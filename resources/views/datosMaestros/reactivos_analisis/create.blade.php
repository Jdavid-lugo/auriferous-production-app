@extends('layouts.app', ['page' => __('Asociar reactivos a un tipo de analisis'), 'pageSlug' => 'reactivos-analisis', 'section' => 'dlaboratorio'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Asociar reactivos a un tipo de analisis') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('reactivos-analisis.index') }}" class="btn btn-sm btn-primary">{{ __('Volver') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('reactivos-analisis.store') }}" autocomplete="off">
                            @csrf
